...
class segnet(nn.Module):
    def __init__(self, in_channel=3):
        ...
        self.block5 = nn.Sequential(maskBasicBlock(530, 256),maskBasicBlock(256, 64))
        self.block6 = nn.Sequential(maskBasicBlock(274, 256),maskBasicBlock(256, 64))
        self.block7 = nn.Sequential(maskBasicBlock(146, 128),maskBasicBlock(128, 64))
